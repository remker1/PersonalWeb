        ...
        <main className="flex-1 flex items-center justify-center px-6 py-12">
          ...
          >
            ...
            <div className="mt-10 flex items-center justify-center gap-6">
              <a href="https://github.com/remker1" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-text-primary transition-colors" aria-label="GitHub">
